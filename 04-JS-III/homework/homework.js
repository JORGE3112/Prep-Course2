...
function agregarNumeros(numeros) {
  // "numeros" debe ser un arreglo (array)de enteros (int/integers)
...
function todosIguales(arreglo) {
 ...
 // arregle [3,3,3,3,3,3,3,]return true
 // key      0 1 2 3 4 5 6  
 // esle return false 
...
function mesesDelAño(array) {
  ...
  // "Enero", "Marzo" y "Noviembre", guardarlo en nuevo array 
  //y retornarlo.
  //Si alguno de los meses no está, devolver: 
  //"No se encontraron los meses pedidos"
  // Tu código:

// Arraycontenedor [ enero, abril, marzo, junio, noviembre]
// key                  0      1     2      3        4
...
function breakStatement(numero) {
  ...
  //la cantidad de iteraciones coinciden, debe 
